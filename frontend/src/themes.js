...
// Ten presets, each modeled after a well-known product's real interface —
// not just a recolor: the `layout` field selects one of the studio-layout-*
// CSS variants (see index.css), so panel density, corner radius, borders,
// and blur/shadow treatment change with the theme too, not only its colors.
